    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="buttons-grid">
                <button class="run-button" id="runButton" onclick="runPrediction('demo')">
                    🚀 全部模型
...
def run_prediction():
    ...
    def generate():
        ...
        try:
            # 根据模型类型构建命令
            if model_type == 'macro':
                cmd = ['python', 'main.py', '--train-macro', '--report', '--data-source', data_source]
            elif model_type == 'fundamental':
                cmd = ['python', 'main.py', '--train-fundamental', '--report', '--data-source', data_source]
            else:  # demo - 运行全部模型
